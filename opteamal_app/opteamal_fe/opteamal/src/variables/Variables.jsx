...
const employeeTdArray = [
  ...
  ["Sage Rodriguez", "john.doe@google.com", "Scrum Master", "2/18/2020", "Project Management"],
  ["Philip Chaney", "john.doe@google.com", "Janitor", "2/18/2020", "Cleaning"],
  ["Doris Greene", "john.doe@google.com", "Data Engineer", "2/18/2020", "ElasticSearch"],
  ["Mason Porter", "john.doe@google.com", "Software Engineer", "2/18/2020", "Python"]
];
...
var dataSales = {
  ...
  series: [
    [67, 152, 143, 240, 287, 335, 400, 437],
    [69, 163, 147, 208, 290, 309, 397, 410]
  ]
};
var optionsSales = {
  low: 0,
...
module.exports = {
  ...
  employeeThArray,
  employeeTdArray,// For tables (TableList view)
  projectTdArray,
  projectThArray,
